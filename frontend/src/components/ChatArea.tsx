...
export interface ChatAreaProps {
  ...
  /** Error message to display (e.g., billing errors from backend) */
...
export function ChatArea({
  ...
  return (
    ...
    >
      ...
      {/* Error message banner (e.g., billing errors) */}
      {errorMessage && !dismissedError && (
        <div
          className="mx-4 mt-3 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg"
          role="alert"
