...
// TODO: Fix flaky billing tests - see GitHub issue #263
// Multiple tests in this suite are timing out waiting for conversation sidebar
test.describe.skip('Billing Error Handling', () => {
  ...
  // TODO: Fix flaky test - conversation doesn't appear in sidebar reliably
  ...
  test('files GitHub issue when billing error occurs', async ({
    page,
    request,
  }) => {
...
// TODO: Fix flaky billing tests - see GitHub issue #263
test.describe.skip('Billing Error Recovery', () => {
  test.beforeEach(async ({ page }) => {
    await setupAuthenticatedUser(page);
  });
